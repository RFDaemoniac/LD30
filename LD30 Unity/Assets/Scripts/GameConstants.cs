...
public class GameConstants : MonoBehaviour {
	...
	//People
	public static string[] names = {"Frank", "Robin", "Sonny", "Stephane", "Alec", "Matt", "Noel", "Chevy", "Rami", "JW", "Pedro", "Kyle", "Brandon", "Zach", "Joakim", "Cole", "Scott", "Jonas", "Greg", "Asher", "Monica", "Arden", "Jade", "Tara", "Amora", "Jenna", "Hannah", "Adriel", "Myriame", "Caroline", "Chelsea", "Zoe", "Karen", "Humaira", "Ashly", "Lucy", "Becca", "Heather", "Rebekka", "Bethany", "Optar"};
